...
const serviceSchema = new mongoose.Schema( {
    ...
    offers: [{type: mongoose.Schema.Types.ObjectId, ref: 'OfferDirect_S5'}],
    ...
    //Service consumer id
    consumer: {type: mongoose.Schema.Types.ObjectId, ref: 'Consumer_S5', required: true},
    //Service provider id
    provider: {type: mongoose.Schema.Types.ObjectId, ref: 'Provider_S5'},
    //Count
...
module.exports = mongoose.model('Service_S5', serviceSchema);
